...
namespace OOP
{
  public class Entity
  {
    ...
    public class Manager
    {
      ...
      public Manager MapComponent<T>() where T : class, IComponent
      {
        Type type = typeof(T);
      ...
      private bool SetComponentInternal<T>(EntityId entityId, T value, bool replaceValue) where T : class, IComponent
      {
      ...
      public void SetComponent<T>(EntityId entity, T value) where T : class, IComponent
      {
        SetComponentInternal(entity, value, true);
      }

      public bool AddComponent<T>(EntityId entity) where T : class, IComponent, new()
      {
        return SetComponentInternal<T>(entity, new T(), true);
      }
      ...
      public bool GetComponent<T>(EntityId entityId, out T component) where T : class, IComponent
      {
      ...
      public class Chain<T> : Chain where T : class, IComponent
      {
        public T[] Components;
